...
import { PostCardComponent } from './ui/post-card-skeleton/post-card/post-card.component';
import { PostCardSkeletonComponent } from './ui/post-card-skeleton/ost-card-skeleton.component';
